...
@Component({
  selector: 'app-read-endscreen',
  templateUrl: './read-endscreen.component.html',
  styleUrls: ['./read-endscreen.component.scss']
})
export class ReadEndscreenComponent implements OnInit {
